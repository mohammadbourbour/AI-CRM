...
class PipelineRun(Base):
    ...
    via: Mapped[str] = mapped_column(String(16), nullable=False, default="crm")
    ...
    n8n_outcome: Mapped[str | None] = mapped_column(String(64), nullable=True)
    sheets_status: Mapped[str | None] = mapped_column(String(64), nullable=True)
